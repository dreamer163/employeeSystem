...
<head>
    ...
    <script src="assets/employee/js/deptlist.js"></script>
</head>
...
<div class="search">
    <form action="" method="post" class="clear">
        <div>
            <label for="dept-id">部门编号</label>
            <input type="text" id="dept-id" placeholder="请输入部门编号" readonly>
        </div>
        <div>
            <label for="name">部门名：</label>
            <input type="text" id="name" placeholder="请输入部门名">
        </div>
        <div>
            <label for="leader">部门领导：</label>
            <input type="text" id="leader" placeholder="输入部门领导名">
        </div>
    </form>
</div>
